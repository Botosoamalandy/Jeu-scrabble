...
public class InterfaceChercherRang {
	...
	public InterfaceChercherRang(JPanel panelPrincipale,JFrame jFrame,Music music) throws Exception {
		...
		btnJouer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					new InterfaceJeu(panelPrincipale,jFrame,music);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
