...
public class Test4 extends JFrame {
	...
	public Test4() throws Exception {
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Music music=new Music(true,1,"win",false);
				try {
		...
		Threads threads=new Threads(plateau, valeur, idPartie, bouttons,true,bouttonChevaler,panel_6,glass,lblL,tour,idJoueur,btnOk,mottrouverJoueur,mottrouverToutLesJoueur,btnNewButton,btnChanger,btnPass,table2,scoreJoueur,lblScore,panel,music,this,table_1);
		threads.start();
